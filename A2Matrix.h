...
void enterIndex(double matrix[30][30], int R, int C);
...
int contain(double m1[30][30], double m2[30][30], int R1, int C1, int R2, int C2);
int is_thesame(double matrix1[30][30], double matrix2[30][30], int R1, int C1, int R2, int C2);

//finding determinant of a matrix
double det(double matrix[30][30], int R, int C);
double det2(double matrix[30][30], int R, int C);
int delRCcoFactor(double matrix[30][30], int R, int C, int dR, int dC, double temp[30][30]);
